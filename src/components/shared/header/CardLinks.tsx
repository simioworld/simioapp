            ...
            return (
              <li
                ...
                className={cn(
                  ...
                  isActive &&
                    " bg-slate-700 opacity-100 border-2 border-white  "
                )}
              >
                <Link href={link.path} className="text-slate-200 ">
                  <article className="relative flex flex-col max-w-1/5 aspect-video duration-1000 transition-all  opacity-100 group-hover:opacity-100 group-hover:bg-transparent/80">
                    <Image
                    ...
                    <h4
                      className={`z-20 ${staatliches.className} group-hover:text-slate-100  opacity-10 group-hover:opacity-100  transition-all duration-500 text-center  tracking-wide font-bold text-[clamp(14px,2vw,36px)] text-grey-400   `}
                    >
                      {link.title}
                    </h4>
                  </article>
