  ...
  return (
    <>
      <nav className="h-full">
        <ul className="flex justify-between gap-[2px] sm:gap-2 w-full ">
              ...
              >
                <Link href={link.path}>
                  <article className="relative flex flex-col max-w-1/5 aspect-video duration-1000 transition-all  opacity-100 group-hover:opacity-100 group-hover:bg-transparent/80 group-hover:rounded-md">
                    ...
                    <h4
                      className={cn(
                        `z-20 ${staatliches.className} group-hover:text-slate-100  opacity-10 group-hover:opacity-100  transition-all duration-500 text-center  tracking-wide font-bold text-[clamp(8px,2vw,36px)]   truncate px-1 `,
